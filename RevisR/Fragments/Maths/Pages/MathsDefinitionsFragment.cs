        ...
        public void defineMaths(int id)
        {
            ...
            using (var builder = new AlertDialog.Builder(Context))
            {
                ...
                var values = new[]
                {
                    ...
                    new KeyValuePair<string, string>("Deciamls to Fractions", "Some are obvious such as 0.5 = ½ or 0.75 = ¾ and 0.1 = 1/10 etc. If it's not obvious write it as a fraction over 10, 100 or 1000 and cancel down."),
